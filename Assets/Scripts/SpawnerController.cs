...
public class SpawnerController : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        //if game is not over we select the animal and start a coroutine
    ...
    //method which selects animal and spawn position
    void SelectAnimal()
    {
        ...
        if (i == 0)
        {
            ...
            //get the script attached to that object
    ...
    void IncreaseDiff()
    {
        ...
        {
            timeMileStoneCount += timeDecreaseMileStone;
            //well this set the new mile stone which the score
